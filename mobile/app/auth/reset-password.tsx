                    ...
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                        ...
                        <View className="flex-1 px-6 items-center pt-4">
                            ...
                            <View className="w-full gap-5">
                                ...
                                {/* Nút Đổi mật khẩu */}
                                <Pressable
                                    className={`w-full mt-4 h-14 rounded-full justify-center items-center shadow-lg active:scale-[0.98] transition-all ${loading ? 'bg-gray-400' : 'bg-emerald-500 shadow-emerald-500/30'
                                        }`}
                                    onPress={handleReset}
                                    disabled={loading}
                                >
