                ...
                >
                    <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                        ...
                        <View className="flex-1 px-6 items-center pt-4">
                            ...
                            {/* Nút Gửi */}
                            <Pressable
                                className={`w-full mt-8 h-14 rounded-full justify-center items-center shadow-lg active:scale-[0.98] transition-all ${loading ? 'bg-gray-400' : 'bg-emerald-500 shadow-emerald-500/30'
                                    }`}
                                onPress={handleSend}
                                disabled={loading}
                            >
